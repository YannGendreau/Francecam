 ...
 */
final class Version20210322115537 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE modele ADD decade INT NOT NULL, ADD sortie INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE modele DROP decade, DROP sortie');
