 ...
 */
final class Version20210319201333 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE FULLTEXT INDEX IDX_5A6F91CE5E237E06 ON marque (name)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_5A6F91CE5E237E06 ON marque');
