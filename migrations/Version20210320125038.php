 ...
 */
final class Version20210320125038 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE FULLTEXT INDEX IDX_100285585E237E06 ON modele (name)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_100285585E237E06 ON modele');
