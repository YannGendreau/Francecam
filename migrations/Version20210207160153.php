 ...
 */
final class Version20210207160153 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE camera DROP INDEX UNIQ_3B1CEE054827B9B2, ADD INDEX IDX_3B1CEE054827B9B2 (marque_id)');
        $this->addSql('ALTER TABLE camera DROP FOREIGN KEY FK_3B1CEE05AC14B70A');
        $this->addSql('DROP INDEX UNIQ_3B1CEE05AC14B70A ON camera');
        $this->addSql('ALTER TABLE camera DROP modele_id');
        $this->addSql('ALTER TABLE modele ADD camera_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE modele ADD CONSTRAINT FK_10028558B47685CD FOREIGN KEY (camera_id) REFERENCES camera (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE camera DROP INDEX IDX_3B1CEE054827B9B2, ADD UNIQUE INDEX UNIQ_3B1CEE054827B9B2 (marque_id)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3B1CEE05AC14B70A ON camera (modele_id)');
